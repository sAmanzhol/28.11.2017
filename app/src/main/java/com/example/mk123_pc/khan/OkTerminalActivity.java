...
public class OkTerminalActivity extends AppCompatActivity {
    private static final String TAG = OkTerminalActivity.class.getSimpleName();
    ...
    private void populateList(String jsonData) {
        ...
        arrayAdapter = new TerminalAdapter(OkTerminalActivity.this, R.layout.item_terminal, ok);
